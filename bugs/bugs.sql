...
(6, 6, '', 'enhancement', 'RESOLVED', '2021-12-24 12:49:49', '2021-12-24 12:51:50', 'Không hiện hình ảnh ở trang khách hàng', 'Windows', '---', 2, 'PC', 5, 'unspecified', 3, 'FIXED', '---', NULL, '', NULL, 1, 1, 1, '0.00', '0.00', NULL);
...
--
ALTER TABLE `bugs`
  MODIFY `bug_id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
